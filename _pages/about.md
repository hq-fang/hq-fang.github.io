...
<span id="handwave">👋🏻</span> Hi! I'm an undergraduate student and researcher at the [University of Washington](https://washington.edu/). I double major in Computer Science (with Honors) and Statistics, with a minor in Mathematics. I also work with the [PRIOR](https://prior.allenai.org/) team at the [Allen Institute for AI](https://allenai.org/).

During undergrad, I am fortunate to be co-advised by Professor [Ranjay Krishna](https://www.ranjaykrishna.com/) at the [RAIVN Lab](https://raivn.cs.washington.edu/) and Professor [Dieter Fox](https://homes.cs.washington.edu/~fox/) at the [Robotics and State Estimation Lab](https://rse-lab.cs.washington.edu/) in UW [Allen School](https://cs.washington.edu/), and advised by Professor [Jenq-Neng Hwang](https://people.ece.uw.edu/hwang/) at the [Information Processing Lab](https://ipl-uw.github.io/) in UW [ECE](https://www.ece.uw.edu/). I am also pleased to collaborate with Dr [Jiafei Duan](https://duanjiafei.com/) and Dr [Ying Jin](https://scholar.google.com/citations?user=MNrLDhwAAAAJ&hl=en/). 
...
- **[Oct 2024]** Our paper *DAug: Diffusion-based Channel Augmentation for Radiology Image Retrieval and Classification* has been accepted to [AIM-FM @ NeurIPS 2024](https://aim-fm-24.github.io/NeurIPS/).
...
<br>
<a href="https://openreview.net/pdf?id=usaZldTu1v">
  <img src="https://img.shields.io/badge/PDF-grey?logo=googledocs&logoColor=white&labelColor=red">
</a>
<a href="https://arxiv.org/abs/2412.04828">
  <img src="https://img.shields.io/badge/arXiv-grey?logo=arxiv&logoColor=white&labelColor=red">
</a>
</div>
</div>
...
<br>*Research Engineer Intern*
  - Supervised by Dr Quan Wang, Explored on [COSMIC](https://cosmic-sizing.org/) Report Generation
